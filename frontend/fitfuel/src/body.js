    ...
    <div>
      ...
      <div className="container text-center mt-5">
        ...
        <div className='container mt-5 d-flex justify-content-center'>
          <div className='card' style={{ width: '870px', height: '230px', borderRadius: '10px' , marginLeft: '15px' }}>
          <div className='row'>
      <div className='col-md-4'>
        <img src='https://images.immediate.co.uk/production/volatile/sites/30/2022/03/Healthy-breakfast-recipes-to-lose-weight-8f35f26.jpg' width="250px" height="230px" alt="Breakfast" style={{ borderRadius: '10px', marginLeft: '0px' }} />
      </div>
      <div className='col-md-8'>
        ...
        <a href='/destination-page'>
          <Button variant="primary" style={{ background: '#198754', color: 'white', border: 'none', width: '90px', height: '40px', marginLeft: '-10px' }}>Explore</Button>
        </a>
      </div>
    </div>
          </div>
        ...
        <div className='container mt-5 d-flex justify-content-center'>
          ...
          <div className='row'>
              <div className='col-md-4'>
                <img src='https://hips.hearstapps.com/hmg-prod/images/healthy-lunch-ideas-air-fryer-salmon-6581fe3189918.jpeg?crop=1xw:1xh;center,top&resize=980:*' width="250px" height="230px" alt="Lunch" style={{ borderRadius: '10px', marginLeft: '0px' }} />
              </div>
              <div className='col-md-8'>
        ...
        <div className='container mt-5 d-flex justify-content-center'>
          ...
          <div className='row'>
              <div className='col-md-4'>
                <img src='https://cdn.shopify.com/s/files/1/2152/6107/t/21/assets/snack_299820876-sml-2-1660277971444.jpg?v=1660277972' width="250px" height="230px" alt="Snacks" style={{ borderRadius: '10px', marginLeft: '0px' }} />
              </div>
              <div className='col-md-8'>
        ...
        <div className='container mt-5 d-flex justify-content-center'>
          ...
          <div className='row'>
             <div className='col-md-4'>
                 <img src='https://img.taste.com.au/iCntbupq/w720-h480-cfill-q80/taste/2019/04/indian-lentil-and-egg-curry-148613-1.jpg' width="250px" height="230px" alt="Dinner" style={{ borderRadius: '10px', marginLeft: '0px' }} />
               </div>
              <div className='col-md-8'>
